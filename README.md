...
| Админ панел | Продукти, цени, файлове, поръчки, категории, купони, потребители, съобщения, настройки |
| Валута | **EUR** официално; преглед BGN (до 31.12.2026) и USD |
...
**Админ по подразбиране** (от seed / `.env`):
