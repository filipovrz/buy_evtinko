    ...
    <>
      <section className="relative overflow-hidden bg-hero-mesh text-white">
        ...
        <div className="container-page relative grid min-h-[78vh] items-center gap-12 py-16 lg:grid-cols-2 lg:py-24">
          <div className="animate-fade-up">
            ...
            <h1 className="max-w-xl text-xl font-medium text-brand-100 sm:text-2xl">
              Buy Software — дигитален магазин за софтуер, апликации и файлове
            </h1>
            <p className="mt-5 max-w-lg text-base leading-relaxed text-ink-300">
              Плащате онлайн с карта, PayPal или ePay.bg. Одобрението е автоматично —
              изтеглянето е готово веднага след плащане. Пазарувайте с акаунт или без.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/catalog" className="btn-primary !px-6 !py-3 text-base">
                Разгледай каталога
              </Link>
              <Link href="/checkout" className="btn-secondary !border-white/20 !bg-white/10 !text-white !px-6 !py-3 text-base hover:!bg-white/20">
                Купи без акаунт
              </Link>
            </div>
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div className="space-y-3">
                  <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-brand-100">
                    <Lock className="h-3.5 w-3.5" /> Защитено изтегляне
                  </div>
                  <p className="font-display text-3xl font-semibold">Плати → Изтегли</p>
      ...
      <section className="border-b border-ink-100 bg-white py-10">
        <div className="container-page grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { icon: CreditCard, title: "Само онлайн", text: "Карта, PayPal, ePay.bg — без наложен платеж." },
            { icon: Zap, title: "Автоматично", text: "Плащането одобрява поръчката веднага." },
            { icon: Download, title: "Сигурен download", text: "Персонален линк с лимит и срок." },
            { icon: Headphones, title: "Поддръжка", text: "Екип на Auctions Evtinko Ltd." },
          ].map((f, i) => (
      ...
      <section className="container-page py-16 md:py-20">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="mb-2 text-sm font-semibold uppercase tracking-wider text-accent">Избрано</p>
        ...
        {featured.length === 0 && (
          <p className="rounded-xl border border-dashed border-ink-200 bg-white p-10 text-center text-ink-500">
            Все още няма продукти. Администраторът може да ги добави от панела.
          </p>
        )}
      </section>
        ...
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-ink-950 via-brand-950 to-ink-900 px-8 py-12 text-white md:px-12">
          <div className="max-w-2xl">
            <h2 className="font-display text-3xl font-semibold md:text-4xl">
              Готови за професионален софтуер?
            </h2>
            <p className="mt-4 text-ink-300">
              Създайте акаунт за история на поръчките или купете веднага като гост —
              изтеглянето е също толкова сигурно.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/register" className="btn-primary">
                Създай акаунт
              </Link>
              <Link href="/catalog" className="btn-secondary !border-white/20 !bg-transparent !text-white hover:!bg-white/10">
                Към каталога
              </Link>
            </div>
          </div>
